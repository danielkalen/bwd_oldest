...
<form class="shipping_calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
	...
	<section class="shipping-calculator-form-dk">
		...
		<p class="form-row form-row-wide">
			...
			<i class="fa fa-angle-down dkfa falong"></i>
		</p>

		<p class="form-row form-row-wide state-select">
			<?php
				...
				if ( is_array( $states ) && empty( $states ) ) {
					...
					?><input type="hidden" name="calc_shipping_state" id="calc_shipping_state" placeholder="<?php _e( 'State', 'woocommerce' ); ?>" /><?php

				// Dropdown Input
				} elseif ( is_array( $states ) ) {

					?><span>
						<select name="calc_shipping_state" id="calc_shipping_state" placeholder="<?php _e( 'State', 'woocommerce' ); ?>">
						...
						<i class="fa fa-angle-down dkfa fashort"></i>
					</span><?php
		...
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_postcode', true ) ) : ?>
			...
			<p class="form-row form-row-wide zip-code">
				<input type="text" class="input-text" value="<?php echo esc_attr( WC()->customer->get_shipping_postcode() ); ?>" placeholder="<?php _e( 'Zip Code', 'woocommerce' ); ?>" name="calc_shipping_postcode" id="calc_shipping_postcode" />
			</p>
